...
class Train(object):
    ...
    def __init__(self, vocab_file_path=None, model_file_path=None):
        ...
        self.train_dataset = data.CodePtrDataset(code_path=config.train_code_path,
                                                 ...
                                                 path_path = config.train_path_path)
        ...
        # new vocab
            ...
            codes, asts, nls, paths = self.train_dataset.get_dataset()
        ...
        self.params = list(self.model.code_encoder.parameters()) + \
            ...
            list(self.model.path_statement_encoder.parameters())+\
            list(self.model.path_token_encoder.parameters())
        ...
        self.optimizer = Adam([
            ...
            {'params': self.model.path_token_encoder.parameters(), 'lr': config.code_encoder_lr},
            {'params': self.model.path_token_attention.parameters(), 'lr': config.code_encoder_lr},
            {'params': self.model.path_statement_encoder.parameters(), 'lr': config.code_encoder_lr},
            {'params': self.model.path_statement_attention.parameters(), 'lr': config.code_encoder_lr},
            {'params': self.model.path_attention.parameters(), 'lr': config.code_encoder_lr},
            {'params': self.model.path_linear.parameters(), 'lr': config.code_encoder_lr}
        ...
        self.best_epoch_batch = (None, None)
    ...
    def get_cur_state_dict(self) -> dict:
        ...
        state_dict = {
                ...
                'path_token_encoder': self.model.path_token_encoder.state_dict(),
                'path_token_attention': self.model.path_token_attention.state_dict(),
                'path_statement_encoder': self.model.path_statement_encoder.state_dict(),
                'path_statement_attention': self.model.path_statement_attention.state_dict(),
                'path_attention': self.model.path_attention.state_dict(),
                'path_linear': self.model.path_linear.state_dict(),
