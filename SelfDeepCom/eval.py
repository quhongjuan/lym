...
class Eval(object):
    ...
    def __init__(self, model):
        ...
        self.dataset = data.CodePtrDataset(code_path=config.valid_code_path,
                                           ...
                                           path_path=config.valid_path_path)
...
class Test(object):
    ...
    def __init__(self, model):
        ...
        self.dataset = data.CodePtrDataset(code_path=config.test_code_path,
                                           ...
                                           path_path=config.test_path_path)
        self.dataset_size = len(self.dataset)
        self.dataloader = DataLoader(dataset=self.dataset,
    ...
    def test_one_batch(self, batch, batch_size):
        ...
        with torch.no_grad():
            ...
            # outputs: [T, B, H]
            # hidden: [1, B, H]
            code_outputs, ast_outputs, decoder_hidden, path_vector = \
    ...
    def beam_decode(self, batch_size, code_outputs: torch.Tensor,
        ...
        for index_batch in range(batch_size):
            ...
            single_path_vector = path_vector[:, index_batch, :].unsqueeze(1) # [1, 1, H]
            ...
            for step in range(config.max_decode_steps):
                ...
                feed_path_vector = single_path_vector.repeat(1, feed_batch_size, 1)
